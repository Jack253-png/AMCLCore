...
import com.mcreater.amclcore.nbtlib.common.tags.ByteArrayTag;
import com.mcreater.amclcore.nbtlib.common.tags.CompoundTag;
import com.mcreater.amclcore.nbtlib.common.tags.ListTag;
import com.mcreater.amclcore.nbtlib.common.tags.LongArrayTag;
...
public class Section implements Comparable<Section> {
    ...
    public Section(CompoundTag sectionRoot, int dataVersion, long loadFlags) {
        ...
        palette = rawPalette.toListTag(CompoundTag.class);
        ...
        if ((loadFlags & BLOCK_LIGHTS) != 0) {
            this.blockLight = blockLight != null ? ArrayUtils.debox(blockLight.getValue()) : null;
        }
        if ((loadFlags & BLOCK_STATES) != 0) {
            this.blockStates = blockStates != null ? ArrayUtils.debox(blockStates.getValue()) : null;
        }
        if ((loadFlags & SKY_LIGHT) != 0) {
            this.skyLight = skyLight != null ? ArrayUtils.debox(skyLight.getValue()) : null;
        }
    }
    ...
    public static Section newSection() {
        ...
        CompoundTag air = new CompoundTag(new HashMap<>());
        air.putString("Name", "minecraft:air");
        s.palette.add(air);
        s.data = new CompoundTag(new HashMap<>());
        return s;
    }
