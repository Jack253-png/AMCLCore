...
public final class NBTUtil {
    ...
    public static void write(AbstractTag<?> tag, File file, boolean compressed) throws IOException {
        write(new NamedTag(null, tag), file, compressed);
    }

    public static void write(AbstractTag<?> tag, String file, boolean compressed) throws IOException {
        write(new NamedTag(null, tag), new File(file), compressed);
    }

    public static void write(AbstractTag<?> tag, File file) throws IOException {
        write(new NamedTag(null, tag), file, true);
    }

    public static void write(AbstractTag<?> tag, String file) throws IOException {
    ...
    public static void writeLE(AbstractTag<?> tag, File file, boolean compressed) throws IOException {
        writeLE(new NamedTag(null, tag), file, compressed);
    }

    public static void writeLE(AbstractTag<?> tag, String file, boolean compressed) throws IOException {
        writeLE(new NamedTag(null, tag), new File(file), compressed);
    }

    public static void writeLE(AbstractTag<?> tag, File file) throws IOException {
        writeLE(new NamedTag(null, tag), file, true);
    }

    public static void writeLE(AbstractTag<?> tag, String file) throws IOException {
